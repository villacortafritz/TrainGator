...
var chartjsBarDemo = {
  ...
  months: function months() {
    return ['Making of the recovery CD', 'Setup','Operations', 'Setup of simulator','Simulator operations', 'HOST Simulator operations'];
  },
  barChart: function barChart() {
    var self = this;
    var data = {
      labels: ['Making of the recovery CD', 'Setup','Operations', 'Setup of simulator','Simulator operations', 'HOST Simulator operations'],
      datasets: [{
        label: 'Pre-Assessment Result',
        backgroundColor: self.getColor('purple'),
        borderColor: self.getColor('purple'),
        borderWidth: 1,
        data: [self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor()]
      }, {
      ...
      // init chart bar
    };var canvas = $('#canvas-testingBar')[0].getContext('2d');
