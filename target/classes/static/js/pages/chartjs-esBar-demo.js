...
var chartjsBarDemo = {
  ...
  months: function months() {
    return ['Grasp of technology trends', 'Communication skill as expert on the field'];
  },
  barChart: function barChart() {
    var self = this;
    var data = {
      labels: ['Grasp of technology trends', 'Communication skill as expert on the field'],
      datasets: [{
        label: 'Pre-Assessment Result',
        backgroundColor: self.getColor('purple'),
        borderColor: self.getColor('purple'),
        borderWidth: 1,
        data: [self.randomScalingFactor(), self.randomScalingFactor()]
      }, {
      ...
      // init chart bar
    };var canvas = $('#canvas-esBar')[0].getContext('2d');
    var chart = new Chart(canvas, {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Systems Engineering Results'
        },
        scales: {
          xAxes: [{
            ticks: {
