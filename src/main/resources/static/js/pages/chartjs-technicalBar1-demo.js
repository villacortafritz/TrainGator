...
var chartjsBarDemo = {
  ...
  months: function months() {
    return ['Understand Specification of the Development','Estimation of Development','Review Specification','Review Source Code','Making of Test Cases','Review Test Cases','Log Analysis','C,C++','.NET','C#','MySQL','HTML','VBS','JAVA,J2EE'];
  },
  // months: function months() {
  //   return ['Win7 Spec','Win7 Development','Linux Spec','Linux Development','NDC','DDC','ISO','IFX','EMV','PCI','CEN/XFS','BIO API'];
  // },
  barChart: function barChart() {
    var self = this;
    var data = {
      labels: ['Understand Specification of the Development','Estimation of Development','Review Specification','Review Source Code','Making of Test Cases','Review Test Cases','Log Analysis','C,C++','.NET','C#','MySQL','HTML','VBS','JAVA,J2EE'],
      datasets: [{
        label: 'Pre-Assessment Result',
        backgroundColor: self.getColor('purple'),
        borderColor: self.getColor('purple'),
        borderWidth: 1,
        data: [self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor()]
      }, {
        label: 'Post-Assessment Result',
      ...
      // init chart bar
    };var canvas = $('#canvas-technicalBar1')[0].getContext('2d');
