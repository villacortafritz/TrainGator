...
var chartjsBarDemo = {
  ...
  barChart: function barChart() {
    var self = this;
    var data = {
      labels: ['Win7 Spec','Win7 Development','Linux Spec','Linux Development','NDC','DDC','ISO','IFX','EMV','PCI','CEN/XFS','BIO API'],
      datasets: [{
        label: 'Pre-Assessment Result',
        backgroundColor: self.getColor('purple'),
        borderColor: self.getColor('purple'),
        borderWidth: 1,
        data: [self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor(),self.randomScalingFactor(), self.randomScalingFactor()]
      }, {
      ...
      // init chart bar
    };var canvas = $('#canvas-technicalBar2')[0].getContext('2d');
