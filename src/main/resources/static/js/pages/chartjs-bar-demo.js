...
var chartjsBarDemo = {
  ...
  months: function months() {
    return ['Scope Management', 'Schedule Management', 'Quality Management', 'Manpower Management', 'Cost Management', 'Communication Management', 'Problem Management', 'Risk Management', 'Leadership', 'Globally Competitive Human Resources', 'Communication Skill', 'Japanese', 'English', 'Development Process', 'Devise Development Plan', 'Bug Analysis', 'Test/SIT/UAT Issue Management During Test/SIT/UAT'];
  },
  barChart: function barChart() {
    var self = this;
    var data = {
      labels: ['Scope Management', 'Schedule Management', 'Quality Management', 'Manpower Management', 'Cost Management', 'Communication Management', 'Problem Management', 'Risk Management', 'Leadership', 'Globally Competitive Human Resources', 'Communication Skill', 'Japanese', 'English', 'Development Process', 'Devise Development Plan', 'Bug Analysis', 'Test/SIT/UAT Issue Management During Test/SIT/UAT'],
      datasets: [{
        label: 'Pre-Assessment Result',
        backgroundColor: self.getColor('purple'),
        borderColor: self.getColor('purple'),
        borderWidth: 1,
        data: [self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor(), self.randomScalingFactor()]
      }, {
