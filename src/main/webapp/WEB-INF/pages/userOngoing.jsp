                ...
                <nav class="page-navs">
                  ...
                  <div class="nav-scroller">
                    ...
                    <div class="nav nav-center nav-tabs">
                      <a class="nav-link" href="userAll.html">All Trainings</a>
                      <a class="nav-link active" href="userOngoing.html">On-going Trainings</a>
                ...
                <div class="page-inner">
                  ...
                  <header class="page-title-bar">
                    ...
                    <div class="form-actions">
                      <!-- .form-group -->
                      <button class="btn btn-primary" type="submit" style="width:100%">Answer Training Needs Analysis Form</button>
                      <!-- .form-group -->
                      <!-- .form-group -->
                    </div>
