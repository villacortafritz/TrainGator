...
<!-- Mirrored from uselooper.com/user-tasks.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Apr 2018 08:09:36 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
          ...
          <div class="page">
            <div class="page-inner" style="padding-left:15%; padding-right:15%;">
              <header class="page-title-bar">
                ...
                <h1 class="page-title"> Training Needs Analysis (TNA)</h1>
              </header>
                    ...
                    <section class="card card-fluid">
                      <div class="card-body">
                        ...
                        <div class="form-actions">
                          <button class="btn btn-primary" type="submit" onclick="window.location.href='userAll.html'">Submit form</button>
                        </div>
                      </div>
                    </section>
                </div>
