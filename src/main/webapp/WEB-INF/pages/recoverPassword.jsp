...
<!-- Mirrored from uselooper.com/auth-recovery-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Apr 2018 08:09:36 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <!-- Begin SEO tag -->
    <title> Password Reset | TrainGator </title>
    ...
    <main class="auth">
      ...
      <form class="auth-form auth-form-reflow">
        ...
        <div class="d-block d-md-inline-block">
          <a href="signin.html" class="btn btn-block btn-light">Return to signin</a>
        </div>
      </form>
    </main>
    <!-- /.auth -->
