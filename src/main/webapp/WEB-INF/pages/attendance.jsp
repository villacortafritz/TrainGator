            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <div class="d-sm-flex align-items-sm-center">
                  <h1 class="page-title mr-sm-auto mb-0" style="padding-left:35%"> Attendance </h1>
                  <!-- .btn-toolbar -->
                      ...
                      <div class="input-group input-group-alt">
                        ...
                        <div class="input-group-prepend">
                          <select class="custom-select">
                            ...
                            <option value="1"> Earliest Time-In </option>
                            <option value="2"> Latest Time-In </option>
                          </select>
                        </div>
                        <!-- /.input-group-prepend -->
                        <!-- .input-group -->
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" placeholder="Search Participant"> </div>
                        <!-- /.input-group -->
                      </div>
                      <!-- /.input-group -->
                    </div>
