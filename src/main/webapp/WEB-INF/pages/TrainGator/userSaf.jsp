      ...
      <div class="wrapper">
        <div class="page">
          <div class="page-inner">
            ...
            <form method="post" action="/user/userSaf?forId=${forId}">
            <div class="page-section">
              <div  class="section-deck">
                    <div class="col-lg-2 float-right">
                      <section class="card card-fluid">
                        <div class="card-body">
                          <select id="exampleSelect1" class="custom-select" readonly name="restype">
                            <c:choose>
                              <c:when test="${forId!=userID}">
                                <c:choose>
                                  <c:when test="${usertype=='Supervisor/Manager'}">
                          ...
                          <h4 class="card-title" style="text-align:Center"> Management </h4>
                            <font size="2px"style="padding-left:427px" > 1 &emsp; &emsp; 2 &emsp; &emsp;3 &emsp; &emsp; 4 &emsp; &emsp;5 &emsp; &emsp; 6 &emsp; &emsp; 7 &emsp; &emsp;8 &emsp; &emsp; 9 &emsp; &emsp;10  </font><br>
                              ...
                              <span class="rating rating-primary">
                                ...
                                <input type="radio" name="5" id="cosTrophy10" value="10">
                      ...
                      <section class="card card-fluid">
                        <div class="card-body">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="23" id="estDTrophy10" value="10">
                            <label style="padding-left:20px" for="estDTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="23" id="estDTrophy9" value="9">
                            <label style="padding-left:20px" for="estDTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="23" id="estDTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="estDTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="23" id="estDTrophy7" value="7">
                            <label style="padding-left:20px" for="estDTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="23" id="estDTrophy6" value="6">
                            <label style="padding-left:20px" for="estDTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="23" id="estDTrophy5" value="5">
                            <label style="padding-left:20px" for="estDTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="23" id="estDTrophy4" value="4">
                            <label style="padding-left:20px" for="estDTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="23" id="estDTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="estDTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="23" id="estDTrophy2" value="2">
                            <label style="padding-left:20px" for="estDTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="23" id="estDTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="24" id="revSpeTrophy10" value="10">
                            <label style="padding-left:20px" for="revSpeTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="24" id="revSpeTrophy9" value="9">
                            <label style="padding-left:20px" for="revSpeTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="24" id="revSpeTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="revSpeTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="24" id="revSpeTrophy7" value="7">
                            <label style="padding-left:20px" for="revSpeTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="24" id="revSpeTrophy6" value="6">
                            <label style="padding-left:20px" for="revSpeTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="24" id="revSpeTrophy5" value="5">
                            <label style="padding-left:20px" for="revSpeTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="24" id="revSpeTrophy4" value="4">
                            <label style="padding-left:20px" for="revSpeTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="24" id="revSpeTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="revSpeTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="24" id="revSpeTrophy2" value="2">
                            <label style="padding-left:20px" for="revSpeTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="24" id="revSpeTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="25" id="revSouTrophy10" value="10">
                            <label style="padding-left:20px" for="revSouTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="25" id="revSouTrophy9" value="9">
                            <label style="padding-left:20px" for="revSouTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="25" id="revSouTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="revSouTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="25" id="revSouTrophy7" value="7">
                            <label style="padding-left:20px" for="revSouTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="25" id="revSouTrophy6" value="6">
                            <label style="padding-left:20px" for="revSouTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="25" id="revSouTrophy5" value="5">
                            <label style="padding-left:20px" for="revSouTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="25" id="revSouTrophy4" value="4">
                            <label style="padding-left:20px" for="revSouTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="25" id="revSouTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="revSouTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="25" id="revSouTrophy2" value="2">
                            <label style="padding-left:20px" for="revSouTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="25" id="revSouTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="26" id="testCaseTrophy10" value="10">
                            <label style="padding-left:20px" for="testCaseTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="26" id="testCaseTrophy9" value="9">
                            <label style="padding-left:20px" for="testCaseTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="26" id="testCaseTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="testCaseTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="26" id="testCaseTrophy7" value="7">
                            <label style="padding-left:20px" for="testCaseTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="26" id="testCaseTrophy6" value="6">
                            <label style="padding-left:20px" for="testCaseTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="26" id="testCaseTrophy5" value="5">
                            <label style="padding-left:20px" for="testCaseTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="26" id="testCaseTrophy4" value="4">
                            <label style="padding-left:20px" for="testCaseTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="26" id="testCaseTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="testCaseTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="26" id="testCaseTrophy2" value="2">
                            <label style="padding-left:20px" for="testCaseTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="26" id="testCaseTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="27" id="revTestCaseTrophy10" value="10">
                            <label style="padding-left:20px" for="revTestCaseTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="27" id="revTestCaseTrophy9" value="9">
                            <label style="padding-left:20px" for="revTestCaseTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="27" id="revTestCaseTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="revTestCaseTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="27" id="revTestCaseTrophy7" value="7">
                            <label style="padding-left:20px" for="revTestCaseTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="27" id="revTestCaseTrophy6" value="6">
                            <label style="padding-left:20px" for="revTestCaseTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="27" id="revTestCaseTrophy5" value="5">
                            <label style="padding-left:20px" for="revTestCaseTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="27" id="revTestCaseTrophy4" value="4">
                            <label style="padding-left:20px" for="revTestCaseTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="27" id="revTestCaseTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="revTestCaseTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="27" id="revTestCaseTrophy2" value="2">
                            <label style="padding-left:20px" for="revTestCaseTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="27" id="revTestCaseTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="28" id="logAnTrophy10" value="10">
                            <label style="padding-left:20px" for="logAnTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="28" id="logAnTrophy9" value="9">
                            <label style="padding-left:20px" for="logAnTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="28" id="logAnTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="logAnTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="28" id="logAnTrophy7" value="7">
                            <label style="padding-left:20px" for="logAnTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="28" id="logAnTrophy6" value="6">
                            <label style="padding-left:20px" for="logAnTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="28" id="logAnTrophy5" value="5">
                            <label style="padding-left:20px" for="logAnTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="28" id="logAnTrophy4" value="4">
                            <label style="padding-left:20px" for="logAnTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="28" id="logAnTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="logAnTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="28" id="logAnTrophy2" value="2">
                            <label style="padding-left:20px" for="logAnTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="28" id="logAnTrophy1" value="1">
                      ...
                      <section class="card card-fluid">
                        <div class="card-body">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="29" id="cTrophy10" value="10">
                            <label style="padding-left:20px" for="cTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="29" id="cTrophy9" value="9">
                            <label style="padding-left:20px" for="cTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="29" id="cTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="cTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="29" id="cTrophy7" value="7">
                            <label style="padding-left:20px" for="cTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="29" id="cTrophy6" value="6">
                            <label style="padding-left:20px" for="cTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="29" id="cTrophy5" value="5">
                            <label style="padding-left:20px" for="cTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="29" id="cTrophy4" value="4">
                            <label style="padding-left:20px" for="cTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="29" id="cTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="cTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="29" id="cTrophy2" value="2">
                            <label style="padding-left:20px" for="cTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="29" id="cTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="30" id="cSharpTrophy10" value="10">
                            <label style="padding-left:20px" for="cSharpTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="30" id="cSharpTrophy9" value="9">
                            <label style="padding-left:20px" for="cSharpTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="30" id="cSharpTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="cSharpTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="30" id="cSharpTrophy7" value="7">
                            <label style="padding-left:20px" for="cSharpTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="30" id="cSharpTrophy6" value="6">
                            <label style="padding-left:20px" for="cSharpTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="30" id="cSharpTrophy5" value="5">
                            <label style="padding-left:20px" for="cSharpTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="30" id="cSharpTrophy4" value="4">
                            <label style="padding-left:20px" for="cSharpTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="30" id="cSharpTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="cSharpTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="30" id="cSharpTrophy2" value="2">
                            <label style="padding-left:20px" for="cSharpTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="30" id="cSharpTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="31" id="netTrophy10" value="10">
                            <label style="padding-left:20px" for="netTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="31" id="netTrophy9" value="9">
                            <label style="padding-left:20px" for="netTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="31" id="netTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="netTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="31" id="netTrophy7" value="7">
                            <label style="padding-left:20px" for="netTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="31" id="netTrophy6" value="6">
                            <label style="padding-left:20px" for="netTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="31" id="netTrophy5" value="5">
                            <label style="padding-left:20px" for="netTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="31" id="netTrophy4" value="4">
                            <label style="padding-left:20px" for="netTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="31" id="netTrophy3" value="3" >
                            <label style="padding-left:20px" for="netTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="31" id="netTrophy2" value="2">
                            <label style="padding-left:20px" for="netTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="31" id="netTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="32" id="mysqlTrophy10" value="10">
                            <label style="padding-left:20px" for="mysqlTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="32" id="mysqlTrophy9" value="9">
                            <label style="padding-left:20px" for="mysqlTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="32" id="mysqlTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="mysqlTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="32" id="mysqlTrophy7" value="7">
                            <label style="padding-left:20px" for="mysqlTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="32" id="mysqlTrophy6" value="6">
                            <label style="padding-left:20px" for="mysqlTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="32" id="mysqlTrophy5" value="5">
                            <label style="padding-left:20px" for="mysqlTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="32" id="mysqlTrophy4" value="4">
                            <label style="padding-left:20px" for="mysqlTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="32" id="mysqlTrophy3" value="3" >
                            <label style="padding-left:20px" for="mysqlTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="32" id="mysqlTrophy2" value="2">
                            <label style="padding-left:20px" for="mysqlTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="32" id="mysqlTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="33" id="htmlTrophy10" value="10">
                            <label style="padding-left:20px" for="htmlTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="33" id="htmlTrophy9" value="9">
                            <label style="padding-left:20px" for="htmlTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="33" id="htmlTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="htmlTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="33" id="htmlTrophy7" value="7">
                            <label style="padding-left:20px" for="htmlTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="33" id="htmlTrophy6" value="6">
                            <label style="padding-left:20px" for="htmlTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="33" id="htmlTrophy5" value="5">
                            <label style="padding-left:20px" for="htmlTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="33" id="htmlTrophy4" value="4">
                            <label style="padding-left:20px" for="htmlTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="33" id="htmlTrophy3" value="3" >
                            <label style="padding-left:20px" for="htmlTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="33" id="htmlTrophy2" value="2">
                            <label style="padding-left:20px" for="htmlTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="33" id="htmlTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="34" id="vbsTrophy10" value="10">
                            <label style="padding-left:20px" for="vbsTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="34" id="vbsTrophy9" value="9">
                            <label style="padding-left:20px" for="vbsTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="34" id="vbsTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="vbsTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="34" id="vbsTrophy7" value="7">
                            <label style="padding-left:20px" for="vbsTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="34" id="vbsTrophy6" value="6">
                            <label style="padding-left:20px" for="vbsTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="34" id="vbsTrophy5" value="5">
                            <label style="padding-left:20px" for="vbsTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="34" id="vbsTrophy4" value="4">
                            <label style="padding-left:20px" for="vbsTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="34" id="vbsTrophy3" value="3" >
                            <label style="padding-left:20px" for="vbsTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="34" id="vbsTrophy2" value="2">
                            <label style="padding-left:20px" for="vbsTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="34" id="vbsTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="35" id="javaTrophy10" value="10">
                            <label style="padding-left:20px" for="javaTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="35" id="javaTrophy9" value="9">
                            <label style="padding-left:20px" for="javaTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="35" id="javaTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="javaTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="35" id="javaTrophy7" value="7">
                            <label style="padding-left:20px" for="javaTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="35" id="javaTrophy6" value="6">
                            <label style="padding-left:20px" for="javaTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="35" id="javaTrophy5" value="5">
                            <label style="padding-left:20px" for="javaTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="35" id="javaTrophy4" value="4">
                            <label style="padding-left:20px" for="javaTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="35" id="javaTrophy3" value="3" >
                            <label style="padding-left:20px" for="javaTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="35" id="javaTrophy2" value="2">
                            <label style="padding-left:20px" for="javaTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="35" id="javaTrophy1" value="1">
                      ...
                      <section class="card card-fluid">
                        <div class="card-body">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="36" id="win7specTrophy10" value="10">
                            <label  style="padding-left:20px" for="win7specTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="36" id="win7specTrophy9" value="9">
                            <label style="padding-left:20px" for="win7specTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="36" id="win7specTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="win7specTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="36" id="win7specTrophy7" value="7">
                            <label style="padding-left:20px" for="win7specTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="36" id="win7specTrophy6" value="6">
                            <label style="padding-left:20px" for="win7specTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="36" id="win7specTrophy5" value="5">
                            <label style="padding-left:20px" for="win7specTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="36" id="win7specTrophy4" value="4">
                            <label style="padding-left:20px" for="win7specTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="36" id="win7specTrophy3" value="3" >
                            <label style="padding-left:20px" for="win7specTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="36" id="win7specTrophy2" value="2">
                            <label style="padding-left:20px" for="win7specTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="36" id="win7specTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="37" id="win7devTrophy10" value="10">
                            <label style="padding-left:20px" for="win7devTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="37" id="win7devTrophy9" value="9">
                            <label style="padding-left:20px" for="win7devTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="37" id="win7devTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="win7devTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="37" id="win7devTrophy7" value="7">
                            <label style="padding-left:20px" for="win7devTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="37" id="win7devTrophy6" value="6">
                            <label style="padding-left:20px" for="win7devTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="37" id="win7devTrophy5" value="5">
                            <label style="padding-left:20px" for="win7devTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="37" id="win7devTrophy4" value="4">
                            <label style="padding-left:20px" for="win7devTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="37" id="win7devTrophy3" value="3" >
                            <label style="padding-left:20px" for="win7devTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="37" id="win7devTrophy2" value="2">
                            <label style="padding-left:20px" for="win7devTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="37" id="win7devTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="38" id="linuxspecTrophy10" value="10">
                            <label style="padding-left:20px" for="linuxspecTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="38" id="linuxspecTrophy9" value="9">
                            <label style="padding-left:20px" for="linuxspecTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="38" id="linuxspecTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="linuxspecTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="38" id="linuxspecTrophy7" value="7">
                            <label style="padding-left:20px" for="linuxspecTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="38" id="linuxspecTrophy6" value="6">
                            <label style="padding-left:20px" for="linuxspecTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="38" id="linuxspecTrophy5" value="5">
                            <label style="padding-left:20px" for="linuxspecTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="38" id="linuxspecTrophy4" value="4">
                            <label style="padding-left:20px" for="linuxspecTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="38" id="linuxspecTrophy3" value="3" >
                            <label style="padding-left:20px" for="linuxspecTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="38" id="linuxspecTrophy2" value="2">
                            <label style="padding-left:20px" for="linuxspecTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="38" id="linuxspecTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="39" id="linuxdevTrophy10" value="10">
                            <label style="padding-left:20px" for="linuxdevTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="39" id="linuxdevTrophy9" value="9">
                            <label style="padding-left:20px" for="linuxdevTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="39" id="linuxdevTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="linuxdevTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="39" id="linuxdevTrophy7" value="7">
                            <label style="padding-left:20px" for="linuxdevTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="39" id="linuxdevTrophy6" value="6">
                            <label style="padding-left:20px" for="linuxdevTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="39" id="linuxdevTrophy5" value="5">
                            <label style="padding-left:20px" for="linuxdevTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="39" id="linuxdevTrophy4" value="4">
                            <label style="padding-left:20px" for="linuxdevTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="39" id="linuxdevTrophy3" value="3" >
                            <label style="padding-left:20px" for="linuxdevTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="39" id="linuxdevTrophy2" value="2">
                            <label style="padding-left:20px" for="linuxdevTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="39" id="linuxdevTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="40" id="ndcTrophy10" value="10">
                            <label style="padding-left:20px" for="ndcTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="40" id="ndcTrophy9" value="9">
                            <label style="padding-left:20px" for="ndcTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="40" id="ndcTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="ndcTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="40" id="ndcTrophy7" value="7">
                            <label style="padding-left:20px" for="ndcTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="40" id="ndcTrophy6" value="6">
                            <label style="padding-left:20px" for="ndcTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="40" id="ndcTrophy5" value="5">
                            <label style="padding-left:20px" for="ndcTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="40" id="ndcTrophy4" value="4">
                            <label style="padding-left:20px" for="ndcTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="40" id="ndcTrophy3" value="3" >
                            <label style="padding-left:20px" for="ndcTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="40" id="ndcTrophy2" value="2">
                            <label style="padding-left:20px" for="ndcTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="40" id="ndcTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="41" id="ddcTrophy10" value="10">
                            <label style="padding-left:20px" for="ddcTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="41" id="ddcTrophy9" value="9">
                            <label style="padding-left:20px" for="ddcTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="41" id="ddcTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="ddcTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="41" id="ddcTrophy7" value="7">
                            <label style="padding-left:20px" for="ddcTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="41" id="ddcTrophy6" value="6">
                            <label style="padding-left:20px" for="ddcTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="41" id="ddcTrophy5" value="5">
                            <label style="padding-left:20px" for="ddcTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="41" id="ddcTrophy4" value="4">
                            <label style="padding-left:20px" for="ddcTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="41" id="ddcTrophy3" value="3" >
                            <label style="padding-left:20px" for="ddcTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="41" id="ddcTrophy2" value="2">
                            <label style="padding-left:20px" for="ddcTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="41" id="ddcTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="42" id="isoTrophy10" value="10">
                            <label style="padding-left:20px" for="isoTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="42" id="isoTrophy9" value="9">
                            <label style="padding-left:20px" for="isoTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="42" id="isoTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="isoTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="42" id="isoTrophy7" value="7">
                            <label style="padding-left:20px" for="isoTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="42" id="isoTrophy6" value="6">
                            <label style="padding-left:20px" for="isoTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="42" id="isoTrophy5" value="5">
                            <label style="padding-left:20px" for="isoTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="42" id="isoTrophy4" value="4">
                            <label style="padding-left:20px" for="isoTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="42" id="isoTrophy3" value="3" >
                            <label style="padding-left:20px" for="isoTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="42" id="isoTrophy2" value="2">
                            <label style="padding-left:20px" for="isoTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="42" id="isoTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="43" id="ifxTrophy10" value="10">
                            <label style="padding-left:20px" for="ifxTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="43" id="ifxTrophy9" value="9">
                            <label style="padding-left:20px" for="ifxTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="43" id="ifxTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="ifxTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="43" id="ifxTrophy7" value="7">
                            <label style="padding-left:20px" for="ifxTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="43" id="ifxTrophy6" value="6">
                            <label style="padding-left:20px" for="ifxTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="43" id="ifxTrophy5" value="5">
                            <label style="padding-left:20px" for="ifxTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="43" id="ifxTrophy4" value="4">
                            <label style="padding-left:20px" for="ifxTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="43" id="ifxTrophy3" value="3" >
                            <label style="padding-left:20px" for="ifxTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="43" id="ifxTrophy2" value="2">
                            <label style="padding-left:20px" for="ifxTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="43" id="ifxTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="44" id="emvTrophy10" value="10">
                            <label style="padding-left:20px" for="emvTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="44" id="emvTrophy9" value="9">
                            <label style="padding-left:20px" for="emvTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="44" id="emvTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="emvTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="44" id="emvTrophy7" value="7">
                            <label style="padding-left:20px" for="emvTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="44" id="emvTrophy6" value="6">
                            <label style="padding-left:20px" for="emvTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="44" id="emvTrophy5" value="5">
                            <label style="padding-left:20px" for="emvTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="44" id="emvTrophy4" value="4">
                            <label style="padding-left:20px" for="emvTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="44" id="emvTrophy3" value="3" >
                            <label style="padding-left:20px" for="emvTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="44" id="emvTrophy2" value="2">
                            <label style="padding-left:20px" for="emvTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="44" id="emvTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="45" id="pciTrophy10" value="10">
                            <label style="padding-left:20px" for="pciTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="45" id="pciTrophy9" value="9">
                            <label style="padding-left:20px" for="pciTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="45" id="pciTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="pciTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="45" id="pciTrophy7" value="7">
                            <label style="padding-left:20px" for="pciTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="45" id="pciTrophy6" value="6">
                            <label style="padding-left:20px" for="pciTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="45" id="pciTrophy5" value="5">
                            <label style="padding-left:20px" for="pciTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="45" id="pciTrophy4" value="4">
                            <label style="padding-left:20px" for="pciTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="45" id="pciTrophy3" value="3" >
                            <label style="padding-left:20px" for="pciTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="45" id="pciTrophy2" value="2">
                            <label style="padding-left:20px" for="pciTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="45" id="pciTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="46" id="cenxfsTrophy10" value="10">
                            <label style="padding-left:20px" for="cenxfsTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="46" id="cenxfsTrophy9" value="9">
                            <label style="padding-left:20px" for="cenxfsTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="46" id="cenxfsTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="cenxfsTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="46" id="cenxfsTrophy7" value="7">
                            <label style="padding-left:20px" for="cenxfsTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="46" id="cenxfsTrophy6" value="6">
                            <label style="padding-left:20px" for="cenxfsTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="46" id="cenxfsTrophy5" value="5">
                            <label style="padding-left:20px" for="cenxfsTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="46" id="cenxfsTrophy4" value="4">
                            <label style="padding-left:20px" for="cenxfsTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="46" id="cenxfsTrophy3" value="3" >
                            <label style="padding-left:20px" for="cenxfsTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="46" id="cenxfsTrophy2" value="2">
                            <label style="padding-left:20px" for="cenxfsTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="46" id="cenxfsTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="47" id="bioapiTrophy10" value="10">
                            <label style="padding-left:20px" for="bioapiTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="47" id="bioapiTrophy9" value="9">
                            <label style="padding-left:20px" for="bioapiTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="47" id="bioapiTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="bioapiTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="47" id="bioapiTrophy7" value="7">
                            <label style="padding-left:20px" for="bioapiTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="47" id="bioapiTrophy6" value="6">
                            <label style="padding-left:20px" for="bioapiTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="47" id="bioapiTrophy5" value="5">
                            <label style="padding-left:20px" for="bioapiTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="47" id="bioapiTrophy4" value="4">
                            <label style="padding-left:20px" for="bioapiTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="47" id="bioapiTrophy3" value="3" >
                            <label style="padding-left:20px" for="bioapiTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="47" id="bioapiTrophy2" value="2">
                            <label style="padding-left:20px" for="bioapiTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="47" id="bioapiTrophy1" value="1">
                      ...
                      <section class="card card-fluid">
                        <div class="card-body">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="48" id="leadTrophy10" value="10">
                            <label  style="padding-left:20px" for="leadTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="48" id="leadTrophy9" value="9">
                            <label style="padding-left:20px" for="leadTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="48" id="leadTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="leadTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="48" id="leadTrophy7" value="7">
                            <label style="padding-left:20px" for="leadTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="48" id="leadTrophy6" value="6">
                            <label style="padding-left:20px" for="leadTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="48" id="leadTrophy5" value="5">
                            <label style="padding-left:20px" for="leadTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="48" id="leadTrophy4" value="4">
                            <label style="padding-left:20px" for="leadTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="48" id="leadTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="leadTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="48" id="leadTrophy2" value="2">
                            <label style="padding-left:20px" for="leadTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="48" id="leadTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="49" id="globTrophy10" value="10">
                            <label style="padding-left:20px" for="globTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="49" id="globTrophy9" value="9">
                            <label style="padding-left:20px" for="globTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="49" id="globTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="globTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="49" id="globTrophy7" value="7">
                            <label style="padding-left:20px" for="globTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="49" id="globTrophy6" value="6">
                            <label style="padding-left:20px" for="globTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="49" id="globTrophy5" value="5">
                            <label style="padding-left:20px" for="globTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="49" id="globTrophy4" value="4">
                            <label style="padding-left:20px" for="globTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="49" id="globTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="globTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="49" id="globTrophy2" value="2">
                            <label style="padding-left:20px" for="globTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="49" id="globTrophy1" value="1">
                          ...
                          <span class="rating rating-primary">
                            ...
                            <input type="radio" name="50" id="comSkillTrophy10" value="10">
                            <label style="padding-left:20px" for="comSkillTrophy10">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="50" id="comSkillTrophy9" value="9">
                            <label style="padding-left:20px" for="comSkillTrophy9">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="50" id="comSkillTrophy8" value="8" checked>
                            <label style="padding-left:20px" for="comSkillTrophy8">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="50" id="comSkillTrophy7" value="7">
                            <label style="padding-left:20px" for="comSkillTrophy7">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="50" id="comSkillTrophy6" value="6">
                            <label style="padding-left:20px" for="comSkillTrophy6">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="50" id="comSkillTrophy5" value="5">
                            <label style="padding-left:20px" for="comSkillTrophy5">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="50" id="comSkillTrophy4" value="4">
                            <label style="padding-left:20px" for="comSkillTrophy4">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="50" id="comSkillTrophy3" value="3" checked>
                            <label style="padding-left:20px" for="comSkillTrophy3">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="50" id="comSkillTrophy2" value="2">
                            <label style="padding-left:20px" for="comSkillTrophy2">
                              <span class="fa fa-trophy"></span>
                            </label>
                            <input type="radio" name="50" id="comSkillTrophy1" value="1">
