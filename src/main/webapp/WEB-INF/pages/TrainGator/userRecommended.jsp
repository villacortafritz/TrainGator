<!-- userRecommended page is only accessible by a user. -->
<!-- userRecommended page is where the user can view the training event the user is recommended to join. -->
    ...
    <nav class="page-navs">
      <div class="nav-scroller">
        <div class="nav nav-center nav-tabs">
          ...
          <a class="nav-link active" href="/user/userRecommended">Recommended Trainings</a>
