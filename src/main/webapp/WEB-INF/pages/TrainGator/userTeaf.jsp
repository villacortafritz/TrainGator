      ...
      <div class="page">
        <div id="printable" class="page-inner" style="padding-left:15%;padding-right:15%;">
          <header class="page-title-bar">
             <text  style="visibility: hidden;"><strong> Training Effectiveness Assessment Form </strong></text><h1 class="page-title"  style="text-align:Center;"> Training Effectiveness Assessment Form </h1>
          </header>
