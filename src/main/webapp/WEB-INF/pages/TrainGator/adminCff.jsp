<!-- adminCff page is only accessible by an administrator. -->
<!-- adminCff is where the administrator can change the questions to be presented in what the user side can see on their version of the CFF. -->
...
<head>
  <title> Admin Course Feedback Form | TrainGator </title>
