                                                  ...
                                                  <section class="card card-fluid"><!-- .card-fluid -->
                                                    <div class="card-body"><!-- .card-body -->
                                                      <c:forEach items="${CatList}" var="CatVar">
                                                        <!-- THIS IS STUDENT : ${CatVar.formId} AND ${CatVar.catDesc}<br/> -->
                                                      <hr>
                                                      <h4 class="card-title" style="padding-left:100px"> ${CatVar.catDesc} </h4>
                                                      ...
                                                      <br>
                                                      <c:forEach items="${SubCatList}" var="SubCatVar">
                                                        <c:if test="${SubCatVar.catId==CatVar.catId}">
                                                      <!-- form -->
