...
<head>
    ...
    <!-- Begin SEO tag -->
    <title> Done Events | TrainGator </title>
            ...
            <div class="page-inner">
              ...
              <header class="page-title-bar">
                ...
                <div class="col-lg-12">
                  ...
                  <section class="card">
                    <!-- .card-header -->
                    <header class="card-header"> Game of Codes 2017 </header>
                    <!-- .card-body -->

                    <!-- /.card-body -->
                    <!-- 16:9 aspect ratio -->
                    <figure class="embed-responsive embed-responsive-16by9 mb-0">
                      <img class="embed-responsive-item" src="/images/dummy/eventposter.jpg" alt="Card image"> </figure>
                    <!-- /.embed-responsive -->
                    <!-- .card-body -->
                    <div class="card-body">
                      <p class="card-text"> Blanditiis architecto quaerat fugit sit ab veritatis ipsam assumenda doloremque repellendus expedita.
                        <a href="#">@stilearningTwit</a> .
                        <a href="#">#looper</a>
                        <a href="#">#admin</a>
                        <br>
                    ...
                    <footer class="card-footer">
                      <div class="card-footer-content text-muted">Training Course </div>
                      <p class="card-text"> Blanditiis architecto quaerat fugit sit ab veritatis ipsam assumenda doloremque repellendus expedita.
                      </p>
                    </footer>
                    <footer class="card-footer">

                    <div class="card-footer-content text-muted">Training Objective </div>
                    <p class="card-text"> Blanditiis architecto quaerat fugit sit ab veritatis ipsam assumenda doloremque repellendus expedita.
                    </p>
                    </footer>
                    <!-- /.card-footer -->
                ...
                <section class="card">
                 ...
                 <div class="nav-scroller">
                   ...
                   <div class="nav nav-center nav-tabs">
                     ...
                     <a class="nav-link " href="doneEvents.html">Event Comments</a>
                     <a class="nav-link active " href="commentFaci.html">Facilitator Comments</a>
                   </div>
                   <!-- /.nav -->
                 </div>
                 <!-- /.nav-scroller -->
