...
<head>
    ...
    <link rel="stylesheet" href="/vendor/At.js/css/jquery.atwho.min.css">
            ...
            <div class="page">
              ...
              <header class="page-cover">
                <div class="text-center">
                  ...
                  <h2 class="h4 mt-3 mb-0"> Name of Admin </h2>
                ...
                <nav class="page-navs">
                  ...
                  <div class="nav-scroller">
                    ...
                    <div class="nav nav-center nav-tabs">
                      <a class="nav-link active" href="adminAll.html">All Trainings</a>
                      ...
                      <a class="nav-link" href="adminDone.html">Accomplished Trainings</a>
                    </div>
                    <!-- /.nav -->
                  </div>
                  <!-- /.nav-scroller -->
                ...
                <div class="page-inner">
                  ...
                  <header class="page-title-bar">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                          ...
                          <div class="card-metric">
                            <div class="metric">
                              ...
                              <h2 class="metric-label"> Registered Participants </h2>
                            </div>
                          </div>
                          <!-- /.metric -->
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                          ...
                          <div class="card-metric">
                            <div class="metric">
                              ...
                              <h2 class="metric-label"> Trainings Created </h2>
                            </div>
                          </div>
                          <!-- /.metric -->
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                          ...
                          <div class="card-metric">
                            <div class="metric">
                              ...
                              <h2 class="metric-label"> Trainings Done </h2>
                            </div>
                          </div>
                          <!-- /.metric -->
                        </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                          ...
                          <div class="card-metric">
                            <div class="metric">
                              ...
                              <h2 class="metric-label"> Successful Trainings </h2>
                            </div>
                          </div>
                          <!-- /.metric -->
                        </div>
                    ...
                    <div class="form-actions">
                      <!-- .form-group -->
                        <button class="btn btn-primary" type="submit" style="width:100%" onclick="window.location.href='createEvent.html'">Create Training</button>
                      <!-- .form-group -->
                      <!-- .form-group -->
                    </div>
                                ...
                                <section class="tasks">
                                  ...
                                  <header class="task-header">
                                    ...
                                    <select class="custom-select" style="width:160px">
                                      ...
                                      <option value="1"> Most Progress </option>
                                      <option value="2"> Least Progress </option>
                                    </select>
                                  </header>
                                  <!-- /.task-header -->
                                  <!-- .task-issue -->
                                    ...
                                    <div class="card">
                                      ...
                                      <header class="card-header">
                                        ...
                                        <h6 class="card-subtitle text-muted">
                                          <time class="text-muted">16:36</time> /
                                          <time class="text-muted">24:00</time>
                                          <span class="mx-1">·</span>
                                          <span class="due-date">
                                            <i class="far fa-fw fa-clock"></i> Apr 02</span>
                                        </h6>
                                      </header>
                                      <!-- /.card-header -->
                                      <!-- .card-body -->
                                        ...
                                        <div class="list-group">
                                          ...
                                          <div class="list-group-item">
                                            ...
                                            <div class="list-group-item-body py-1 text-truncate">
                                              <a href="#" class="tile tile-sm bg-indigo text-white" data-toggle="tooltip" title="Smart Paper Project">SP</a>
                                              <span class="text-muted mx-2">
                                                <i class="fa fa-long-arrow-alt-right"></i>
                                              </span>
                                              <!-- members -->
                                              <div class="avatar-group">
                                                <a href="#" class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Sarah Bishop">
                                                  <img src="/images/avatars/uifaces2.jpg" alt="Sarah Bishop">
                                                </a>
                                                <a href="#" class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Johnny Day">
                                                  <img src="/images/avatars/uifaces3.jpg" alt="Johnny Day">
                                                </a>
                                                <a href="#" class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Jane Barnes">
                                                  <img src="/images/avatars/uifaces4.jpg" alt="Jane Barnes">
                                                </a>
                                              </div>
                                              <!-- /members -->
                                            </div>
                                      ...
                                      <footer class="card-footer">
                                        <a href="#" class="card-footer-item card-footer-item-bordered text-muted">
                                          <i class="oi oi-comment-square mr-1"></i> 12</a>
                                        <a href="#" class="card-footer-item card-footer-item-bordered text-muted">
                                  ...
                                  <div class="task-issue">
                                    ...
                                    <div class="card">
                                      ...
                                      <header class="card-header">
                                        ...
                                        <h6 class="card-subtitle text-muted">
                                          <time class="text-muted">03:36</time> /
                                          <time class="text-muted">04:00</time>
                                          <span class="mx-1">·</span>
                                          <span class="due-date">
                                            <i class="far fa-fw fa-clock"></i> In 3 days</span>
                                        </h6>
                                      </header>
                                      <!-- /.card-header -->
                                      <!-- .card-body -->
                                      <div class="card-body">
                                        ...
                                        <div class="list-group">
                                          ...
                                          <div class="list-group-item">
                                            <!-- .list-group-item-body -->
                                            <div class="list-group-item-body py-1 text-truncate">
                                              <a href="#" class="tile tile-sm bg-blue text-white" data-toggle="tooltip" title="Looper Admin Theme Project">LT</a>
                                              <span class="text-muted mx-2">
                                                <i class="fa fa-long-arrow-alt-right"></i>
                                              </span>
                                              <!-- members -->
                                  ...
                                  <div class="task-issue">
                                    ...
                                    <div class="card">
                                      ...
                                      <header class="card-header">
                                        ...
                                        <h6 class="card-subtitle text-muted">
                                          <time class="text-red">50:02</time> /
                                          <time class="text-muted">48:00</time>
                                          <span class="mx-1">·</span>
                                          <span class="due-date">
                                            <i class="far fa-fw fa-clock"></i> Tomorrow</span>
                                        </h6>
                                      </header>
                                      <!-- /.card-header -->
                                      <!-- .card-body -->
                                      <div class="card-body">
                                        ...
                                        <div class="list-group">
                                          ...
                                          <div class="list-group-item">
                                            <!-- .list-group-item-body -->
                                            <div class="list-group-item-body py-1 text-truncate">
                                              <a href="#" class="tile tile-sm bg-yellow text-white" data-toggle="tooltip" title="Online Store Project">OS</a>
                                              <span class="text-muted mx-2">
                                                <i class="fa fa-long-arrow-alt-right"></i>
                                              </span>
                                              <!-- members -->
                                      ...
                                      <footer class="card-footer">
                                        <a href="#" class="card-footer-item card-footer-item-bordered text-muted">
                                          <i class="oi oi-comment-square mr-1"></i> 36</a>
                                        <a href="#" class="card-footer-item card-footer-item-bordered text-muted">
                                          <i class="fa fa-pause"></i>
                                        </a>
                                      </footer>
                                  ...
                                  <div class="task-issue">
                                    ...
                                    <div class="card">
                                      ...
                                      <header class="card-header">
                                        ...
                                        <h6 class="card-subtitle text-muted">
                                          <time class="text-muted">08:36</time> /
                                          <time class="text-muted">12:00</time>
                                          <span class="mx-1">·</span>
                                          <span class="due-date">
                                            <i class="far fa-fw fa-clock"></i> In 2 days</span>
                                        </h6>
                                      </header>
                                      <!-- /.card-header -->
                                      <!-- .card-body -->
                                          ...
                                          <div class="list-group-item">
                                            ...
                                            <div class="list-group-item-body py-1 text-truncate">
                                              ...
                                              <div class="avatar-group">
                                                ...
                                                <a href="#" class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Nicole Barnett">
                                                  <img src="/images/avatars/uifaces5.jpg" alt="Nicole Barnett">
                                                </a>
                                              </div>
                                              <!-- /members -->
                                            </div>
                                      ...
                                      <footer class="card-footer">
                                        <a href="#" class="card-footer-item card-footer-item-bordered text-muted">
                                          <i class="oi oi-comment-square mr-1"></i> 8</a>
                                        <a href="#" class="card-footer-item card-footer-item-bordered text-muted">
                                          <i class="fa fa-pause"></i>
                                        </a>
                                      </footer>
                                  ...
                                  <div class="task-issue">
                                    ...
                                    <div class="card">
                                      ...
                                      <header class="card-header">
                                        ...
                                        <h6 class="card-subtitle text-muted">
                                          <time class="text-muted">03:11</time> /
                                          <time class="text-muted">6:00</time>
                                          <span class="mx-1">·</span>
                                          <span class="due-date">
                                            <i class="far fa-fw fa-clock"></i> Apr 07</span>
                                        </h6>
                                      </header>
                                      <!-- /.card-header -->
                                      <!-- .card-body -->
                                      <div class="card-body">
                                        ...
                                        <div class="list-group">
                                          ...
                                          <div class="list-group-item">
                                            <!-- .list-group-item-body -->
                                            <div class="list-group-item-body py-1 text-truncate">
                                              <a href="#" class="tile tile-sm bg-pink text-white" data-toggle="tooltip" title="Syrena Project Project">SP</a>
                                              <span class="text-muted mx-2">
                                                <i class="fa fa-long-arrow-alt-right"></i>
                                              </span>
                                              <!-- members -->
                                  ...
                                  <div class="task-issue">
                                    ...
                                    <div class="card">
                                      ...
                                      <header class="card-header">
                                        ...
                                        <h6 class="card-subtitle text-muted">
                                          <time class="text-muted">11:36</time> /
                                          <time class="text-muted">12:00</time>
                                          <span class="mx-1">·</span>
                                          <span class="due-date">
                                            <i class="far fa-fw fa-clock"></i> Mar 23</span>
                                        </h6>
                                      </header>
                                      <!-- /.card-header -->
                                      <!-- .card-body -->
                                      ...
                                      <footer class="card-footer">
                                        <a href="#" class="card-footer-item card-footer-item-bordered text-muted">
                                          <i class="oi oi-comment-square mr-1"></i> 24</a>
                                        <a href="#" class="card-footer-item card-footer-item-bordered text-muted">
                                          <i class="fa fa-pause"></i>
                                        </a>
                                      </footer>
        ...
        <div class="input-group input-group-alt">
          ...
          <div class="input-group-prepend">
            <select class="custom-select">
              ...
              <option value="2"> Most Number of Requests </option>
              <option value="3"> Most Number of Participants </option>
            </select>
          </div>
          <!-- /.input-group-prepend -->
          <!-- .input-group -->
          <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="Search Training"> </div>
          <!-- /.input-group -->
        </div>
        <!-- /.input-group -->
      </div>
            ...
            <tr>
              <th style="width:62px">
                <div class="thead-dd dropdown">
                  <span class="table-custom-control custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="cb">
                    <label class="custom-control-label" for="cb"></label>
                  </span>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="align-middle text-right">
                <div class="btn-group">
                  <button class="btn btn-primary" type="submit" onclick="window.location.href='trainingEvents.html'">View Details of Training</button>
                </div>
              </td>
            </tr>
            <!-- /tr -->
        ...
        <table class="table">
          ...
          <thead>
            <tr>
              ...
              <th style="min-width:280px"> Accomplished Training List </th>
              <th> Success Rate </th>
              <th> Failure Rate </th>
              <th style="width: 50px;"> &nbsp; </th>
            </tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="align-middle text-right">
                <div class="btn-group">
                  <button class="btn btn-primary" type="submit" onclick="window.location.href='doneEvents.html'">View Results of Training</button>
                </div>
              </td>
            </tr>
            <!-- /tr -->
...
<!-- /.page -->
    ...
    <script src="/vendor/tribute/tribute.min.js"></script>
    <script src="/vendor/Caret/jquery.caret.min.js"></script>
    <script src="/vendor/At.js/js/jquery.atwho.min.js"></script>
    ...
    <script src="/vendor/blueimp-file-upload/js/jquery.fileupload-process.js"></script>
    <script src="/vendor/blueimp-file-upload/js/jquery.fileupload-image.js"></script>
    <script src="/vendor/blueimp-file-upload/js/jquery.fileupload-audio.js"></script>
    <script src="/vendor/blueimp-file-upload/js/jquery.fileupload-video.js"></script>
    <script src="/vendor/blueimp-file-upload/js/jquery.fileupload-validate.js"></script>
    <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="/js/main.min.js"></script>

    <script src="/js/pages/typeahead-demo.js"></script>
    <script src="/js/pages/select2-demo.js"></script>
    <script src="/js/pages/atwho-demo.js"></script>
    <script src="/js/pages/tribute-demo.js"></script>
    <script src="/js/pages/flatpickr-demo.js"></script>
    <script src="/js/pages/colorpicker-demo.js"></script>
    <script src="/js/pages/uploader-demo.js"></script>
    <script src="/js/pages/slider-demo.js"></script>

    <script src="/js/pages/profile-demo.js"></script>
    <script src="/js/pages/chartjs-bar-demo.js"></script>
    <script src="/js/pages/chartjs-esBar-demo.js"></script>
    <script src="/js/pages/chartjs-technicalBar1-demo.js"></script>
    <script src="/js/pages/chartjs-technicalBar2-demo.js"></script>
    <script src="/js/pages/chartjs-testingBar-demo.js"></script>
