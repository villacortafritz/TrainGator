              ...
              <div class="page">
                ...
                <nav class="page-navs">
                  ...
                  <div class="nav-scroller">
                    ...
                    <div class="nav nav-center nav-tabs">
                      <a class="nav-link active" href="userAll.html">All Trainings</a>
                      <a class="nav-link" href="userOngoing.html">On-going Trainings</a>
                      ...
                      <a class="nav-link" href="userDone.html">Accomplished Trainings</a>
                    </div>
                    <!-- /.nav -->
                  </div>
                  <!-- /.nav-scroller -->
                ...
                <div class="page-inner">
                  ...
                  <header class="page-title-bar">
                    ...
                    <div>
                      <!-- .form-group -->
                      <button class="btn btn-primary" type="submit" style="width:100%" formaction="tna.html">Answer Training Needs Analysis Form</button>
                    </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="align-middle text-right">
                <div class="btn-group">
                  <button class="btn btn-primary" type="submit">Request to Join Training</button>
                </div>
              </td>
            </tr>
            <!-- /tr -->
        ...
        <table class="table">
          ...
          <thead>
            <tr>
              ...
              <th style="min-width:280px"> Recommended Training List </th>
              <th> Number of Requests </th>
              <th> Number of Participants </th>
              <th style="width: 50px;"> &nbsp; </th>
            </tr>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="align-middle text-right">
                <div class="btn-group">
                  <button class="btn btn-primary" type="submit" onclick="window.location.href='cff.html'">Answer Course Feedback Form of Training</button>
                </div>
              </td>
            </tr>
            <!-- /tr -->
